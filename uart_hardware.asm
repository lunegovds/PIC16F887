...
; ГЛОБАЛЬНЫЕ ФУНКЦИИ
;-------------------------------------------------------------------------------
    global  UartInit, UartPutChar, UartGetChar, UartReturnData
;-------------------------------------------------------------------------------
...
;*******************************************************************************
;* ФУНКЦИИ  : прием и возврат данных по UART
;* ВХОД     : uart_data_in из функции UartGetChar
;* ВЫХОД    : uart_data_out в функцию UartPutChar	
;*******************************************************************************	
UartReturnData
